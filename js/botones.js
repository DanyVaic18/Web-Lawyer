...
const arrBtnHechos = [
  {
    ...
    numHecho: "Hecho 1",
    contenido:
      "La alcaldía municipal de Cúcuta no es la encargada de los procesos de mecina o EPS, por el reclamo de medicamentos, camillas, quejas, citas, falta de personal, mala atención; Por favor comunicarse con la EPS primero, antes de enviar una petición de tutela.",
    agregado: false,
  },
  {
    _id: "hecho-2",
  ...
  },
  {
    ...
    numHecho: "Hecho 3",
    contenido:
      "La alcaldía de Cúcuta, ha delegado sobre los hechos sobre reclamos de instrumentos, articulos, materiales, objetos deportivos como (balones, mallas, aros, canchas, entre demás objetos), cuya realización es cada inicio de año.",
    agregado: false,
  },
  {
    _id: "hecho-4",
...
const arrBtnTipos = [
  {
    ...
    numTipo: "Tipo 1",
    contenido:
      "Copia de representacion legal de la copropiedad o entidad de la empresa",
    agregado: false,
  },
  {
    _id: "tipo-2",
    numTipo: "Tipo 2",
    contenido:
      "Respuesta por medio dirijido al accionante, con adjuntos en relación al requerimiento y el cual fue rotundamente negado a recibir la reunión por parte de la comunidad y la alcaldía sobre los damnidicados de la zona.",
    agregado: false,
  },
  {
    _id: "tipo-3",
    numTipo: "Tipo 3",
    contenido:
      "En respuesta a los elementos, instrumentos, objetos y/o artículos para las instictuciones públicas se les ha dicho que hablen con la entidad de su comuna para suministrar lo que hace falta, igual forma reciben el suficiente dinero para adquirir la compra de los materiales que hace falta.",
    agregado: false,
  },
  {
    _id: "tipo-4",
    numTipo: "Tipo 4",
    contenido:
      "Con razón en los hechos presentados en la peticón en la tutela respondo que la alcaldía municipal no es responsable ante peticones, reclamos, quejas, respecto a otras entidades o empresas de la ciudad.",
    agregado: false,
  },
];
